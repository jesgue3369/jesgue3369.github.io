...
let player = {
    ...
    health: 100,
    maxHealth: 100,
    mana: 100, // Alterado para 100
    maxMana: 100, // Alterado para 100
    level: 1,
    xp: 0,
...
const PLAYER_ANIMATION_AMPLITUDE = 5; // Aumentado para 5 pixels de flutuação
const PLAYER_ANIMATION_SPEED = 5; // Aumentado para uma animação mais rápida e visível
...
// --- Funções de Desenho ---
function drawPlayer() {
    const playerYAdjusted = player.y + playerAnimationOffset; // Ajusta a posição Y do jogador
